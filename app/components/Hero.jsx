...
const Hero = () => {
  return (
    <div className="w-full h-screen relative flex flex-col md:flex-row justify-evenly space-y-5 items-center text-center md:text-left md:min-h-screen md:max-h-fit">
